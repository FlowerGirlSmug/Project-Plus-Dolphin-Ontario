...
rm -rf ./AppDir/usr/Source/Core/DolphinQt/project-plus-dolphin-ontario_autogen
rm ./AppDir/usr/Source/Core/DolphinQt/cmake_install.cmake
rm ./AppDir/usr/bin/project-plus-dolphin-ontario-nogui
rm ./AppDir/usr/bin/dolphin-tool
mv ./AppDir/usr/share/project-plus-dolphin-ontario/sys ./AppDir/usr/bin/Sys
rm -rf ./AppDir/usr/share/project-plus-dolphin-ontario
sed -i 's/env QT_QPA_PLATFORM=xcb project-plus-dolphin-ontario/project-plus-dolphin-ontario/g' ./AppDir/usr/share/applications/project-plus-dolphin-ontario-ontario.desktop
