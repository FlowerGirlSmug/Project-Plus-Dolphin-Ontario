...
void InstallUpdateDialog::install()
{
  ...
  QString extractDirectory = this->temporaryDirectory + QDir::separator() + QStringLiteral("Project-Plus-Dolphin-Ontario");
  ...
  if (this->filename.endsWith(QStringLiteral(".zip")))
  {
    ...
    {
      if (!dir.mkdir(QStringLiteral("Project-Plus-Dolphin-Ontario")))
      {
